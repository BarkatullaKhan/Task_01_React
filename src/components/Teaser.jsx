...
const Teaser = (props) => {
  ...
  return (
    <div className="container-fluid p-2 teaser">
      <h1 className="text-center py-2 teaser-title">{props.title}</h1>

      <div className="container">
        <div className="row m-auto">
          {itemsArray.map((item) => {
            return (
              <div className="col-md-6 col-sm-6 col-xs-12 col-lg-3 m-auto " key={item}>
                <div
                  className="card teaser-card  border-0 mt-2 align-items-center justify-content-center "
                  key={item}
                >
                  <img
